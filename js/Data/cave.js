...
var caveData ={
	info:{
		layout:[
			...
			[2,x,x,7,x,x,7,x,x,x,x,x,x,7,7,x,7,7,x,x,x,x,x,x,7,x,x,x,x,x,7,7,x,x,2],
	...
	var caveBackData ={
		info:{
			layout:[
			[0,8,8,8,8,2,8,2,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8],
			[x,8,1,8,1,8,1,8,8,8,8,8,8,1,8,8,8,8,1,8,8,8,8,8,8,1,8,8,8,8,8,8,8,1,8],
			[x,8,8,1,8,2,8,1,8,8,1,8,8,8,8,1,1,8,1,8,1,8,8,5,8,8,8,8,1,8,8,8,1,8,8],
			[x,8,1,8,1,0,3,3,3,0,8,8,8,8,8,8,8,8,8,0,3,3,3,3,3,3,0,1,8,8,1,5,8,8,8],
			[2,8,8,1,8,2,x,x,x,2,8,1,8,1,8,8,1,8,8,2,x,x,x,x,x,x,2,8,8,8,8,8,1,8,8],
			[2,8,1,8,1,0,3,3,3,0,8,8,8,8,8,8,8,8,8,0,3,3,3,3,3,3,0,8,1,8,1,8,8,1,8],
			[2,8,8,1,8,1,8,1,5,8,1,8,8,1,8,8,5,1,8,8,1,8,1,8,8,1,8,8,8,8,8,8,8,8,8],
			],
			src:`images/bg3.png`,
		},
